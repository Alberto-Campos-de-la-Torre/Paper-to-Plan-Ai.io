...
Ollama instalado y ejecutándose. Descargar aquí.
...
Nueva Nota: Haz clic en el botón "+" y selecciona una foto de tu libreta o servilleta.

Procesamiento: La app intentará leerla primero con OCR rápido. Si es confusa, usará LLaVA (esto puede tardar unos segundos dependiendo de tu GPU).

Revisión: Verás la tarjeta de la nota en el tablero. Haz clic para ver el "Plan de Mejora" generado por la IA.

Filtrado: Usa los filtros laterales para ver solo proyectos de "Corto Plazo" para victorias rápidas.
